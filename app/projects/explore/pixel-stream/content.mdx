...
<AutoPlayVideo src={image.src} alt="指哪贴哪，所见即所得" />

import latex from './videos/latex.mp4';

<AutoPlayVideo src={latex.src} alt="识别数学公式，输入到 Word" />

import words from './videos/words.mp4';

<AutoPlayVideo src={words.src} alt="识别输入文字" />
