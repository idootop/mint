...
<BaseImage src={neuralNetwork.src} alt="人工神经网络示意图" />
...
import stage1Random from './images/stage-1-random.gif';

<BaseImage src={stage1Random.src} alt="无头苍蝇，到处乱闯" />
...
import stage2Stable from './images/stage-2-stable.gif';

<BaseImage src={stage2Stable.src} alt="学会稳定飞行" />
...
import stage3Free from './images/stage-3-free.gif';

<BaseImage src={stage3Free.src} alt="在管道间自由穿梭" />
