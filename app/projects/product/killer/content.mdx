...
Killer 这个名称是指，它就像是一个选课杀手一样，总是能够帮你选到自己心仪的课程，所向无敌。

最初这个项目，只是一个相对简陋的 Python 脚本，只供我自己一个人使用，有时也会帮我的室友选课。

后来，我喜欢上一位法语系的小姑娘，就想着做一个能在她手机上安装和使用的 APP，帮她也选上想要的课程，然后便有了这个项目。

当时我在自己的公众号上，也向同学们宣传过这个项目。后来不知道是哪位小可爱，因为自己没选上课，向学校教务处举报了这个项目，我还差点被学校教务处请去“喝茶”…… 从那以后，这个项目就对外终止维护了。
...
模型训练好之后，我把模型量化成了适合在移动端部署的 TensorFlow Lite 格式，实现了在端侧离线识别验证码，最终识别率达到了 90% 以上，远高于人类的平均识别准确率。

import acc from './images/model_acc.jpg';

<BaseImage src={acc.src} alt="模型准确率" />
